...
public  class ProcessInput extends haxe.java.io.NativeInput
{
	...
	public static   void __hx_ctor_sys_io__Process_ProcessInput(sys.io._Process.ProcessInput __temp_me41, java.io.InputStream stream)
	{
		haxe.java.io.NativeInput.__hx_ctor_haxe_java_io_NativeInput(__temp_me41, stream);
	}
	...
	{
		{
			int __temp_hash258 = field.hashCode();
			boolean __temp_executeDef257 = true;
			switch (__temp_hash258)
			{
				case 94756344:case -1140063115:case -868060226:
				{
					if (( (( ( __temp_hash258 == 94756344 ) && field.equals("close") )) || ( (( ( __temp_hash258 == -1140063115 ) && field.equals("readBytes") )) || field.equals("readByte") ) )) 
					{
