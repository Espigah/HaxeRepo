...
public  class Process extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_sys_io_Process(sys.io.Process __temp_me40, java.lang.String cmd, haxe.root.Array<java.lang.String> args)
	{
		...
		try 
		{
			__temp_me40.proc = new java.lang.ProcessBuilder(((java.lang.String[]) (pargs) )).start();
		}
		catch (java.lang.Throwable __temp_catchallException253)
		{
			java.lang.Object __temp_catchall254 = __temp_catchallException253;
			if (( __temp_catchall254 instanceof haxe.lang.HaxeException )) 
			{
				__temp_catchall254 = ((haxe.lang.HaxeException) (__temp_catchallException253) ).obj;
			}
			
			{
				java.lang.Object e = __temp_catchall254;
		...
		java.lang.Process p = __temp_me40.proc;
		__temp_me40.stderr = new sys.io._Process.ProcessInput(((java.io.InputStream) (p.getErrorStream()) ));
		__temp_me40.stdout = new sys.io._Process.ProcessInput(((java.io.InputStream) (p.getInputStream()) ));
		__temp_me40.stdin = new haxe.java.io.NativeOutput(((java.io.OutputStream) (p.getOutputStream()) ));
	}
