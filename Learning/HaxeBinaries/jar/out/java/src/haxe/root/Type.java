...
public  class Type extends haxe.lang.HxObject
{
	...
	public static   java.lang.String getClassName(java.lang.Class c)
	{
		...
		{
			java.lang.String __temp_svar74 = (name);
			...
			switch (__temp_hash76)
			{
				...
				{
					if (( (( ( __temp_hash76 == -672261858 ) && __temp_svar74.equals("Integer") )) || __temp_svar74.equals("int") )) 
					{
				...
				case -1939501217:
				{
					if (__temp_svar74.equals("Object")) 
					{
						__temp_executeDef75 = false;
						return "Dynamic";
					}
				...
				{
					if (( (( ( __temp_hash76 == 2052876273 ) && __temp_svar74.equals("Double") )) || __temp_svar74.equals("double") )) 
					{
						__temp_executeDef75 = false;
						return "Float";
					}
