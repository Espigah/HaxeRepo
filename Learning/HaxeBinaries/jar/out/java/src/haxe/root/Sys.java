...
public  class Sys extends haxe.lang.HxObject
{
	...
	public static   haxe.ds.StringMap<java.lang.String> environment()
	{
		...
		{
			java.util.Iterator<java.util.Map.Entry> __temp_iterator43 = ((java.util.Iterator<java.util.Map.Entry>) (((java.util.Iterator) (java.lang.System.getenv().entrySet().iterator()) )) );
			while (__temp_iterator43.hasNext())
			{
				java.util.Map.Entry<java.lang.String, java.lang.String> mv = ((java.util.Map.Entry<java.lang.String, java.lang.String>) (((java.util.Map.Entry) (__temp_iterator43.next()) )) );
	...
	public static   void sleep(double seconds)
	{
		...
		catch (java.lang.Throwable __temp_catchallException72)
		{
			...
			{
				java.lang.Object e = __temp_catchall73;
