...
public  class BytesInput extends haxe.io.Input
{
	...
	public static   void __hx_ctor_haxe_io_BytesInput(haxe.io.BytesInput __temp_me24, haxe.io.Bytes b, java.lang.Object pos, java.lang.Object len)
	{
		if (( pos == null )) 
		{
			pos = 0;
		...
		__temp_me24.b = b.b;
		__temp_me24.pos = ((int) (haxe.lang.Runtime.toInt(pos)) );
		__temp_me24.len = ((int) (haxe.lang.Runtime.toInt(len)) );
		__temp_me24.totlen = ((int) (haxe.lang.Runtime.toInt(len)) );
	}
	...
	{
		{
			int __temp_hash211 = field.hashCode();
			boolean __temp_executeDef210 = true;
			switch (__temp_hash211)
			{
				case -1140063115:case -868060226:
				{
					if (( (( ( __temp_hash211 == -1140063115 ) && field.equals("readBytes") )) || field.equals("readByte") )) 
					{
