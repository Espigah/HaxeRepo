...
public  class Output extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxe_io_Output(haxe.io.Output __temp_me25)
	{
		{
		}
	...
	public   void writeInput(haxe.io.Input i, java.lang.Object bufsize)
	{
		...
		catch (java.lang.Throwable __temp_catchallException212)
		{
			java.lang.Object __temp_catchall213 = __temp_catchallException212;
			if (( __temp_catchall213 instanceof haxe.lang.HaxeException )) 
			{
				__temp_catchall213 = ((haxe.lang.HaxeException) (__temp_catchallException212) ).obj;
			}
			
			if (( __temp_catchall213 instanceof haxe.io.Eof )) 
			{
				haxe.io.Eof e = ((haxe.io.Eof) (__temp_catchall213) );
				{
					{
					}
			...
			{
				throw haxe.lang.HaxeException.wrap(__temp_catchallException212);
			}
