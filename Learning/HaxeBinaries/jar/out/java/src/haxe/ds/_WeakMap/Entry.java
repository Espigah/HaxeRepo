...
public  class Entry<K, V> extends java.lang.ref.WeakReference<K> implements haxe.lang.IHxObject
{
	...
	{
		{
			int __temp_hash183 = field.hashCode();
			boolean __temp_executeDef182 = true;
			switch (__temp_hash183)
			{
				case -1594257912:case 1324341926:case 94746189:case 102230:
				{
					if (( (( ( __temp_hash183 == -1594257912 ) && field.equals("enqueue") )) || ( (( ( __temp_hash183 == 1324341926 ) && field.equals("isEnqueued") )) || ( (( ( __temp_hash183 == 94746189 ) && field.equals("clear") )) || field.equals("get") ) ) )) 
					{
