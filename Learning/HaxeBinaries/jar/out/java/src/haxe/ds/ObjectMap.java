...
public  class ObjectMap<K, V> extends haxe.lang.HxObject implements haxe.root.IMap<K, V>
{
	...
	public static  <K_c, V_c> void __hx_ctor_haxe_ds_ObjectMap(haxe.ds.ObjectMap<K_c, V_c> __temp_me18)
	{
	...
	public   void set(K key, V value)
	{
		...
		int[] hashes1 = hashes;
		{
			 ...
			 else 
			{
				...
				do 
				{
					boolean __temp_stmt111 = false;
					{
						int v = flag = hashes1[i];
						__temp_stmt111 = ( (( v & -2 )) == 0 );
					}
					
					boolean __temp_boolv112 = false;
					if ( ! (__temp_stmt111) ) 
					{
						__temp_boolv112 = ( ( flag == k ) && keys[i].equals(key) );
					}
					
					boolean __temp_stmt110 = ( __temp_stmt111 || __temp_boolv112 );
					if ( ! ((__temp_stmt110)) ) 
					{
						i = ( ( i +  ++ nProbes ) & mask );
					}
	...
	public   int lookup(K key)
	{
		if (( this.nBuckets != 0 )) 
		{
			...
			do 
			{
				boolean __temp_stmt116 = false;
				{
					int v = flag = hashes[i];
					__temp_stmt116 = ( v == 0 );
				}
				
				boolean __temp_boolv115 =  ! (__temp_stmt116) ;
				boolean __temp_boolv114 = false;
				if (__temp_boolv115) 
				{
					__temp_boolv114 = (( ( ( flag == 1 ) || ( flag != k1 ) ) ||  ! (keys[i].equals(key))  ));
				}
				
				boolean __temp_stmt113 = ( __temp_boolv115 && __temp_boolv114 );
				if (__temp_stmt113) 
				{
					i = ( ( i +  ++ nProbes ) & mask );
				}
	...
	public   void resize(int newNBuckets)
	{
		...
		if (( j != 0 )) 
		{
			...
			{
				int k1 = 0;
				boolean __temp_stmt117 = false;
				{
					int v1 = k1 = hashes[j];
					__temp_stmt117 = ( (( v1 & -2 )) == 0 );
				}
				...
				if ( ! (__temp_stmt117) ) 
				{
					...
					while (true)
					{
						...
						newHash[i] = k1;
						boolean __temp_boolv120 = ( i < nBuckets );
						boolean __temp_boolv119 = false;
						if (__temp_boolv120) 
						{
							boolean __temp_stmt121 = false;
							{
								int v2 = k1 = hashes[i];
								__temp_stmt121 = ( (( v2 & -2 )) == 0 );
							}
							
							__temp_boolv119 =  ! (__temp_stmt121) ;
						}
						
						boolean __temp_stmt118 = ( __temp_boolv120 && __temp_boolv119 );
						if (__temp_stmt118) 
						{
							{
								K tmp = _keys[i];
	...
	public   java.lang.Object keys()
	{
		...
		{
			haxe.lang.Function __temp_odecl122 = new haxe.ds.ObjectMap_keys_356__Fun<V, K>(((haxe.root.Array<haxe.ds.ObjectMap>) (_g1) ), ((haxe.root.Array<java.lang.Object>) (len) ), ((haxe.root.Array<java.lang.Object>) (i) ));
			haxe.lang.Function __temp_odecl123 = new haxe.ds.ObjectMap_keys_367__Fun<V, K>(((haxe.root.Array<haxe.ds.ObjectMap>) (_g1) ), ((haxe.root.Array<java.lang.Object>) (i) ));
			return new haxe.lang.DynamicObject(new haxe.root.Array<java.lang.String>(new java.lang.String[]{"hasNext", "next"}), new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{__temp_odecl122, __temp_odecl123}), new haxe.root.Array<java.lang.String>(new java.lang.String[]{}), new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{}));
		}
	...
	public   java.lang.Object iterator()
	{
		...
		haxe.root.Array<java.lang.Object> len = new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{this.nBuckets});
		{
			haxe.lang.Function __temp_odecl124 = new haxe.ds.ObjectMap_iterator_387__Fun<V, K>(((haxe.root.Array<haxe.ds.ObjectMap>) (_g1) ), ((haxe.root.Array<java.lang.Object>) (len) ), ((haxe.root.Array<java.lang.Object>) (i) ));
			haxe.lang.Function __temp_odecl125 = new haxe.ds.ObjectMap_iterator_398__Fun<K, V>(((haxe.root.Array<haxe.ds.ObjectMap>) (_g1) ), ((haxe.root.Array<java.lang.Object>) (i) ));
			return new haxe.lang.DynamicObject(new haxe.root.Array<java.lang.String>(new java.lang.String[]{"hasNext", "next"}), new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{__temp_odecl124, __temp_odecl125}), new haxe.root.Array<java.lang.String>(new java.lang.String[]{}), new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{}));
		}
	...
	@Override public   java.lang.String toString()
	{
		...
		{
			java.lang.Object __temp_iterator45 = it;
			while (haxe.lang.Runtime.toBool(haxe.lang.Runtime.callField(__temp_iterator45, "hasNext", null)))
			{
				K i = ((K) (haxe.lang.Runtime.callField(__temp_iterator45, "next", null)) );
