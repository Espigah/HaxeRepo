...
public  class StringMap<T> extends haxe.lang.HxObject implements haxe.root.IMap<java.lang.String, T>
{
	...
	public   void set(java.lang.String key, T value)
	{
		...
		int[] hashes1 = hashes;
		{
			 ...
			 else 
			{
				...
				do 
				{
					boolean __temp_stmt132 = false;
					{
						int v = flag = hashes1[i];
						__temp_stmt132 = ( (( v & -2 )) == 0 );
					}
					
					boolean __temp_boolv133 = false;
					if ( ! (__temp_stmt132) ) 
					{
						__temp_boolv133 = ( ( flag == k ) && haxe.lang.Runtime.valEq(this._keys[i], key) );
					}
					
					boolean __temp_stmt131 = ( __temp_stmt132 || __temp_boolv133 );
					if ( ! ((__temp_stmt131)) ) 
					{
						i = ( ( i +  ++ nProbes ) & mask );
					}
	...
	public   int lookup(java.lang.String key)
	{
		if (( this.nBuckets != 0 )) 
		{
			...
			do 
			{
				boolean __temp_stmt137 = false;
				{
					int v = flag = hashes[i];
					__temp_stmt137 = ( v == 0 );
				}
				
				boolean __temp_boolv136 =  ! (__temp_stmt137) ;
				boolean __temp_boolv135 = false;
				if (__temp_boolv136) 
				{
					__temp_boolv135 = (( ( ( flag == 1 ) || ( flag != k1 ) ) ||  ! (haxe.lang.Runtime.valEq(keys[i], key))  ));
				}
				
				boolean __temp_stmt134 = ( __temp_boolv136 && __temp_boolv135 );
				if (__temp_stmt134) 
				{
					i = ( ( i +  ++ nProbes ) & mask );
				}
			...
			while ((  ++ j < nBuckets ))
			{
				...
				if ( ! (__temp_stmt138) ) 
				{
					...
					while (true)
					{
						...
						newHash[i] = k1;
						boolean __temp_boolv141 = ( i < nBuckets );
						boolean __temp_boolv140 = false;
						if (__temp_boolv141) 
						{
							boolean __temp_stmt142 = false;
							{
								int v2 = k1 = hashes[i];
								__temp_stmt142 = ( (( v2 & -2 )) == 0 );
							}
							
							__temp_boolv140 =  ! (__temp_stmt142) ;
						}
						
						boolean __temp_stmt139 = ( __temp_boolv141 && __temp_boolv140 );
						if (__temp_stmt139) 
						{
							{
	...
	public   java.lang.Object keys()
	{
		...
		{
			haxe.lang.Function __temp_odecl143 = new haxe.ds.StringMap_keys_356__Fun<T>(((haxe.root.Array<java.lang.Object>) (len) ), ((haxe.root.Array<java.lang.Object>) (i) ), ((haxe.root.Array<haxe.ds.StringMap>) (_g1) ));
			haxe.lang.Function __temp_odecl144 = new haxe.ds.StringMap_keys_367__Fun<T>(((haxe.root.Array<java.lang.Object>) (i) ), ((haxe.root.Array<haxe.ds.StringMap>) (_g1) ));
			return new haxe.lang.DynamicObject(new haxe.root.Array<java.lang.String>(new java.lang.String[]{"hasNext", "next"}), new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{__temp_odecl143, __temp_odecl144}), new haxe.root.Array<java.lang.String>(new java.lang.String[]{}), new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{}));
		}
	...
	public   java.lang.Object iterator()
	{
		...
		haxe.root.Array<java.lang.Object> len = new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{this.nBuckets});
		{
			haxe.lang.Function __temp_odecl145 = new haxe.ds.StringMap_iterator_387__Fun<T>(((haxe.root.Array<haxe.ds.StringMap>) (_g1) ), ((haxe.root.Array<java.lang.Object>) (i) ), ((haxe.root.Array<java.lang.Object>) (len) ));
			haxe.lang.Function __temp_odecl146 = new haxe.ds.StringMap_iterator_398__Fun<T>(((haxe.root.Array<haxe.ds.StringMap>) (_g1) ), ((haxe.root.Array<java.lang.Object>) (i) ));
			return new haxe.lang.DynamicObject(new haxe.root.Array<java.lang.String>(new java.lang.String[]{"hasNext", "next"}), new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{__temp_odecl145, __temp_odecl146}), new haxe.root.Array<java.lang.String>(new java.lang.String[]{}), new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{}));
		}
	...
	@Override public   java.lang.String toString()
	{
		...
		{
			java.lang.Object __temp_iterator46 = it;
			while (haxe.lang.Runtime.toBool(haxe.lang.Runtime.callField(__temp_iterator46, "hasNext", null)))
			{
				java.lang.String i = haxe.lang.Runtime.toString(haxe.lang.Runtime.callField(__temp_iterator46, "next", null));
				s.add(i);
				s.add(" => ");
