...
public  class TreeNode<K, V> extends haxe.lang.HxObject
{
	...
	public static  <K_c, V_c> void __hx_ctor_haxe_ds_TreeNode(haxe.ds.TreeNode<K_c, V_c> __temp_me13, haxe.ds.TreeNode<K_c, V_c> l, K_c k, V_c v, haxe.ds.TreeNode<K_c, V_c> r, java.lang.Object h)
	{
		int __temp_h12 = ( (( h == null )) ? (((int) (-1) )) : (((int) (haxe.lang.Runtime.toInt(h)) )) );
		__temp_me13.left = l;
		__temp_me13.key = k;
		__temp_me13.value = v;
		__temp_me13.right = r;
		if (( __temp_h12 == -1 )) 
		{
			...
			int __temp_stmt95 = 0;
			{
				haxe.ds.TreeNode<K_c, V_c> _this = __temp_me13.left;
				__temp_stmt95 = ( (( _this == null )) ? (0) : (_this._height) );
			}
			
			int __temp_stmt96 = 0;
			{
				haxe.ds.TreeNode<K_c, V_c> _this1 = __temp_me13.right;
				__temp_stmt96 = ( (( _this1 == null )) ? (0) : (_this1._height) );
			}
			
			if (( __temp_stmt95 > __temp_stmt96 )) 
			{
				haxe.ds.TreeNode<K_c, V_c> _this2 = __temp_me13.left;
				__temp_stmt94 = ( (( _this2 == null )) ? (0) : (_this2._height) );
			}
			 else 
			{
				haxe.ds.TreeNode<K_c, V_c> _this3 = __temp_me13.right;
				__temp_stmt94 = ( (( _this3 == null )) ? (0) : (_this3._height) );
			}
			
			__temp_me13._height = ( __temp_stmt94 + 1 );
		}
		 else 
		{
			__temp_me13._height = __temp_h12;
		}
