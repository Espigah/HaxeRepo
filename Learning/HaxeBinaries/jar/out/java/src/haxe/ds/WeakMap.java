...
public  class WeakMap<K, V> extends haxe.lang.HxObject implements haxe.root.IMap<K, V>
{
	...
	public static  <K_c, V_c> void __hx_ctor_haxe_ds_WeakMap(haxe.ds.WeakMap<K_c, V_c> __temp_me20)
	{
		__temp_me20.cachedIndex = -1;
		__temp_me20.queue = new java.lang.ref.ReferenceQueue<K_c>();
	}
		...
		while (( ! (( (x = this.queue.poll()) == null )) ))
		{
			...
			if (( nOccupied != 0 )) 
			{
				...
				do 
				{
					...
					boolean __temp_boolv154 =  ! (__temp_stmt155) ;
					boolean __temp_boolv153 = false;
					if (__temp_boolv154) 
					{
						__temp_boolv153 = (( ( ( flag == 1 ) || ( flag != hash ) ) || ( this.entries[i] != x1 ) ));
					}
					
					boolean __temp_stmt152 = ( __temp_boolv154 && __temp_boolv153 );
					if (__temp_stmt152) 
					{
						i = ( ( i +  ++ nProbes ) & mask );
					}
		...
		haxe.ds._WeakMap.Entry<K, V>[] entries = this.entries;
		{
			 ...
			 else 
			{
				...
				do 
				{
					...
					{
						int v = flag = hashes[i];
						__temp_stmt157 = ( (( v & -2 )) == 0 );
					}
					
					boolean __temp_boolv158 = false;
					if ( ! (__temp_stmt157) ) 
					{
						__temp_boolv158 = ( ( flag == k ) && (( ( ! (( key == null )) ) && key.equals(entries[i].get()) )) );
					}
					
					boolean __temp_stmt156 = ( __temp_stmt157 || __temp_boolv158 );
					if ( ! ((__temp_stmt156)) ) 
					{
						i = ( ( i +  ++ nProbes ) & mask );
					}
			...
			{
				{
					...
					java.lang.Object __temp_expr159 = null;
				}
	...
	public   int lookup(K key)
	{
		if (( this.nBuckets != 0 )) 
		{
			...
			do 
			{
				...
				boolean __temp_boolv162 =  ! (__temp_stmt163) ;
				boolean __temp_boolv161 = false;
				if (__temp_boolv162) 
				{
					__temp_boolv161 = (( ( ( flag == 1 ) || ( flag != k1 ) ) ||  ! ((( ( ! (( key == null )) ) && key.equals(entries[i].get()) )))  ));
				}
				
				boolean __temp_stmt160 = ( __temp_boolv162 && __temp_boolv161 );
				if (__temp_stmt160) 
				{
					i = ( ( i +  ++ nProbes ) & mask );
				}
	...
	public   void resize(int newNBuckets)
	{
		...
		if (( j != 0 )) 
		{
			...
			{
				int k = 0;
				boolean __temp_stmt164 = false;
				{
					int v = k = hashes[j];
					__temp_stmt164 = ( (( v & -2 )) == 0 );
				}
				...
				if ( ! (__temp_stmt164) ) 
				{
					...
					while (true)
					{
						...
						newHash[i] = k;
						boolean __temp_boolv167 = ( i < nBuckets );
						...
						if (__temp_boolv167) 
						{
							...
							{
								int v1 = k = hashes[i];
								__temp_stmt168 = ( (( v1 & -2 )) == 0 );
							}
							
							__temp_boolv166 =  ! (__temp_stmt168) ;
						}
	...
	public   java.lang.Object keys()
	{
		...
		{
			haxe.lang.Function __temp_odecl169 = new haxe.ds.WeakMap_keys_388__Fun<V, K>(((haxe.root.Array<haxe.ds.WeakMap>) (_g1) ), ((haxe.root.Array<K>) (lastKey) ), ((haxe.root.Array<java.lang.Object>) (len) ), ((haxe.root.Array<java.lang.Object>) (i) ));
			haxe.lang.Function __temp_odecl170 = new haxe.ds.WeakMap_keys_407__Fun<K>(((haxe.root.Array<K>) (lastKey) ), ((haxe.root.Array<java.lang.Object>) (i) ));
			return new haxe.lang.DynamicObject(new haxe.root.Array<java.lang.String>(new java.lang.String[]{"hasNext", "next"}), new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{__temp_odecl169, __temp_odecl170}), new haxe.root.Array<java.lang.String>(new java.lang.String[]{}), new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{}));
		}
	...
	public   java.lang.Object iterator()
	{
		...
		haxe.root.Array<java.lang.Object> len = new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{this.nBuckets});
		{
			haxe.lang.Function __temp_odecl171 = new haxe.ds.WeakMap_iterator_424__Fun<V, K>(((haxe.root.Array<haxe.ds.WeakMap>) (_g1) ), ((haxe.root.Array<java.lang.Object>) (len) ), ((haxe.root.Array<java.lang.Object>) (i) ));
			haxe.lang.Function __temp_odecl172 = new haxe.ds.WeakMap_iterator_435__Fun<K, V>(((haxe.root.Array<haxe.ds.WeakMap>) (_g1) ), ((haxe.root.Array<java.lang.Object>) (i) ));
			return new haxe.lang.DynamicObject(new haxe.root.Array<java.lang.String>(new java.lang.String[]{"hasNext", "next"}), new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{__temp_odecl171, __temp_odecl172}), new haxe.root.Array<java.lang.String>(new java.lang.String[]{}), new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{}));
		}
	...
	@Override public   java.lang.String toString()
	{
		...
		{
			java.lang.Object __temp_iterator47 = it;
			while (haxe.lang.Runtime.toBool(haxe.lang.Runtime.callField(__temp_iterator47, "hasNext", null)))
			{
				K i = ((K) (haxe.lang.Runtime.callField(__temp_iterator47, "next", null)) );
