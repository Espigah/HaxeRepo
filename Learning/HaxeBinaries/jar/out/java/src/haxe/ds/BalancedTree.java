...
public  class BalancedTree<K, V> extends haxe.lang.HxObject
{
	...
	public static  <K_c, V_c> void __hx_ctor_haxe_ds_BalancedTree(haxe.ds.BalancedTree<K_c, V_c> __temp_me11)
	{
		{
		}
	...
	public   boolean remove(K key)
	{
		...
		catch (java.lang.Throwable __temp_catchallException80)
		{
			java.lang.Object __temp_catchall81 = __temp_catchallException80;
			if (( __temp_catchall81 instanceof haxe.lang.HaxeException )) 
			{
				__temp_catchall81 = ((haxe.lang.HaxeException) (__temp_catchallException80) ).obj;
			}
			
			if (( __temp_catchall81 instanceof java.lang.String )) 
			{
				java.lang.String e = haxe.lang.Runtime.toString(__temp_catchall81);
				{
					return false;
				}
			...
			{
				throw haxe.lang.HaxeException.wrap(__temp_catchallException80);
			}
	...
	public   haxe.ds.TreeNode<K, V> balance(haxe.ds.TreeNode<K, V> l, K k, V v, haxe.ds.TreeNode<K, V> r)
	{
		...
		if (( hl > ( hr + 2 ) )) 
		{
			int __temp_stmt84 = 0;
			{
				...
				__temp_stmt84 = ( (( _this == null )) ? (0) : (_this._height) );
			}
			
			int __temp_stmt85 = 0;
			{
				haxe.ds.TreeNode<K, V> _this1 = l.right;
				__temp_stmt85 = ( (( _this1 == null )) ? (0) : (_this1._height) );
			}
			
			if (( __temp_stmt84 >= __temp_stmt85 )) 
			{
		 ...
		 else 
		{
			if (( hr > ( hl + 2 ) )) 
			{
				int __temp_stmt82 = 0;
				{
					...
					__temp_stmt82 = ( (( _this2 == null )) ? (0) : (_this2._height) );
				}
				
				int __temp_stmt83 = 0;
				{
					haxe.ds.TreeNode<K, V> _this3 = r.left;
					__temp_stmt83 = ( (( _this3 == null )) ? (0) : (_this3._height) );
				}
				
				if (( __temp_stmt82 > __temp_stmt83 )) 
				{
