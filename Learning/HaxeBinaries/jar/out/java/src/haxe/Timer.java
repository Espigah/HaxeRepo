...
public  class Timer extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxe_Timer(haxe.Timer __temp_me10, int time_ms)
	{
		__temp_me10.run = ( (( haxe.Timer___hx_ctor_haxe_Timer_113__Fun.__hx_current != null )) ? (haxe.Timer___hx_ctor_haxe_Timer_113__Fun.__hx_current) : (haxe.Timer___hx_ctor_haxe_Timer_113__Fun.__hx_current = ((haxe.Timer___hx_ctor_haxe_Timer_113__Fun) (new haxe.Timer___hx_ctor_haxe_Timer_113__Fun()) )) );
		__temp_me10.timer = new java.util.Timer();
		__temp_me10.timer.scheduleAtFixedRate(((java.util.TimerTask) (__temp_me10.task = new haxe._Timer.TimerTask(((haxe.Timer) (__temp_me10) ))) ), ((long) (time_ms) ), ((long) (time_ms) ));
	}
	...
	public static   haxe.Timer delay(haxe.lang.Function f, int time_ms)
	{
		...
		t.__get(0).run = new haxe.Timer_delay_128__Fun(((haxe.root.Array<haxe.Timer>) (t) ), ((haxe.root.Array<haxe.lang.Function>) (f1) ));
		return t.__get(0);
	}
