...
public sealed class Array<T> : global::haxe.lang.HxObject, global::Array {
	...
	public   object Array_cast<T_c>(){
		unchecked {
			...
			{
				#line 31 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				object __temp_iterator24 = global::Reflect.fields(this).iterator();
				#line 31 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				while (global::haxe.lang.Runtime.toBool(global::haxe.lang.Runtime.callField(__temp_iterator24, "hasNext", 407283053, default(global::Array)))){
					#line 31 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
					string field = global::haxe.lang.Runtime.toString(global::haxe.lang.Runtime.callField(__temp_iterator24, "next", 1224901875, default(global::Array)));
					#line 31 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
					switch (field){
						case "__a":
						{
	...
	public   string @join(string sep){
		unchecked {
			#line 115 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
	...
	public   void quicksort(int lo, int hi, global::haxe.lang.Function f){
		unchecked {
			...
			while (( i <= j )){
				...
				#line 232 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
	...
	public   global::Array<T> splice(int pos, int len){
		unchecked {
			...
			this.length -= len;
			while ((  -- len >= 0 )){
				#line 269 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
	...
	public   void spliceVoid(int pos, int len){
		unchecked {
			...
			this.length -= len;
			while ((  -- len >= 0 )){
				#line 293 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				a[( this.length + len )] = default(T);
			}
	...
	public   void unshift(T x){
		unchecked {
			...
			if (( length >= ( __a as global::System.Array ).Length )) {
				...
				#line 327 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
	...
	public   bool @remove(T x){
		unchecked {
			...
			int length = this.length;
			while ((  ++ i < length )){
				#line 375 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				if (global::haxe.lang.Runtime.eq(__a[i], x)) {
					#line 377 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
	...
	public   global::Array<S> map<S>(global::haxe.lang.Function f){
		unchecked {
			...
			{
				#line 389 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				int _g = 0;
				#line 389 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
	...
	public   T __get(int idx){
		unchecked {
			#line 418 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			T[] __a = this.__a;
			uint idx1 = ((uint) (idx) );
			if (( idx1 >= this.length )) {
	...
	public   T __unsafe_get(int idx){
		unchecked {
			#line 448 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			return this.__a[idx];
		}
		#line default
	}
	...
	public   T __unsafe_set(int idx, T val){
		unchecked {
			#line 453 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
	...
	public sealed class ArrayIterator<T> : global::haxe.lang.HxObject, global::_Array.ArrayIterator {
		...
		public   object _Array_ArrayIterator_cast<T_c>(){
			unchecked {
				...
				{
					#line 458 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
					object __temp_iterator25 = global::Reflect.fields(this).iterator();
					#line 458 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
					while (global::haxe.lang.Runtime.toBool(global::haxe.lang.Runtime.callField(__temp_iterator25, "hasNext", 407283053, default(global::Array)))){
						#line 458 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
						string field = global::haxe.lang.Runtime.toString(global::haxe.lang.Runtime.callField(__temp_iterator25, "next", 1224901875, default(global::Array)));
						#line 458 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
						switch (field){
							default:
							{
		...
		public   bool hasNext(){
			unchecked {
				#line 471 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
