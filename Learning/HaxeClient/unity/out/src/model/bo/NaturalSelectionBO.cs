...
namespace model.bo{
	public  class NaturalSelectionBO : global::haxe.lang.HxObject {
		public    NaturalSelectionBO(global::haxe.lang.EmptyObject empty){
			unchecked {
				#line 8 "E:\\Data\\HAXE\\Learning\\_src\\model\\bo\\NaturalSelectionBO.hx"
				{
				}
		...
		public    NaturalSelectionBO(){
			unchecked {
				#line 11 "E:\\Data\\HAXE\\Learning\\_src\\model\\bo\\NaturalSelectionBO.hx"
		...
		public static   void __hx_ctor_model_bo_NaturalSelectionBO(global::model.bo.NaturalSelectionBO __temp_me21){
			unchecked {
				#line 12 "E:\\Data\\HAXE\\Learning\\_src\\model\\bo\\NaturalSelectionBO.hx"
				{
				}
		...
		public virtual   global::model.vo.PersonVO getStrongest(global::Array<object> _personVOList){
			unchecked {
				#line 18 "E:\\Data\\HAXE\\Learning\\_src\\model\\bo\\NaturalSelectionBO.hx"
				global::model.vo.PersonVO personVO = default(global::model.vo.PersonVO);
				int length = _personVOList.length;
				{
					#line 20 "E:\\Data\\HAXE\\Learning\\_src\\model\\bo\\NaturalSelectionBO.hx"
					int _g = 0;
					#line 20 "E:\\Data\\HAXE\\Learning\\_src\\model\\bo\\NaturalSelectionBO.hx"
					while (( _g < length )){
						#line 20 "E:\\Data\\HAXE\\Learning\\_src\\model\\bo\\NaturalSelectionBO.hx"
						int i = _g++;
						#line 22 "E:\\Data\\HAXE\\Learning\\_src\\model\\bo\\NaturalSelectionBO.hx"
						global::model.vo.PersonVO tmpPerson = ((global::model.vo.PersonVO) (_personVOList[i]) );
						if (( personVO == default(global::model.vo.PersonVO) )) {
							#line 25 "E:\\Data\\HAXE\\Learning\\_src\\model\\bo\\NaturalSelectionBO.hx"
							personVO = tmpPerson;
						}
						 else {
							#line 27 "E:\\Data\\HAXE\\Learning\\_src\\model\\bo\\NaturalSelectionBO.hx"
							if (( tmpPerson.get_power() > personVO.get_power() )) {
								#line 29 "E:\\Data\\HAXE\\Learning\\_src\\model\\bo\\NaturalSelectionBO.hx"
								personVO = tmpPerson;
							}
				...
				#line 34 "E:\\Data\\HAXE\\Learning\\_src\\model\\bo\\NaturalSelectionBO.hx"
				return personVO;
			}
			#line default
		}
