...
@:keep #if display private #end class __ASSET__assets_fonts_oxygen_bold_ttf extends flash.text.Font { #if (!openfl_html5_dom) public function new () { super (); fontName = "Oxygen Bold"; } #end }
@:keep #if display private #end class __ASSET__assets_fonts_oxygen_ttf extends flash.text.Font { #if (!openfl_html5_dom) public function new () { super (); fontName = "Oxygen Regular"; } #end }
...
@:keep #if display private #end class __ASSET__fonts_oxygen_bold_ttf extends flash.text.Font { #if (!openfl_html5_dom) public function new () { super (); fontName = "Oxygen Bold"; } #end }
@:keep #if display private #end class __ASSET__fonts_oxygen_ttf extends flash.text.Font { #if (!openfl_html5_dom) public function new () { super (); fontName = "Oxygen Regular"; } #end }
